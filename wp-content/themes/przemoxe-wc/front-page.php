...
?>
    ...
    <section class="container popular-products">
        <div class="row d-flex justify-content-center">
            ...
            <p class="text-center">Lorem ipsum dolor sit amet consectetur, adipisicing elit. <br> Optio totam nulla nisi?</p>
        </div>
        ...
        <div class="container">
            ...
            <div class="row pt-5">
                <div class="categories__col col-md-4 col-sm-12 mb-3">
                    <a href="#" class="col-md-12 w-100 h-100 d-inline-block p-3 position-relative round-15 overflow-hidden">
                        ...
                        <h2 class="position-absolute bottom-0 start-0 end-0 p-2 mb-0 text-center text-white color-1-opacity-8">Toys</h2>
                    </a>
                </div>
                <div class="categories__col col-md-4 col-sm-12 mb-3">
                    <a href="#" class="col-md-12 w-100 h-100 d-inline-block p-3 position-relative round-15 overflow-hidden">
                        ...
                        <h2 class="position-absolute bottom-0 start-0 end-0 p-2 mb-0 text-center text-white color-1-opacity-8">Food</h2>
                    </a>
                </div>
                <div class="categories__col col-md-4 col-sm-12 mb-3">
                    <a href="#" class="col-md-12 w-100 h-100 d-inline-block p-3 position-relative round-15 overflow-hidden">
                        ...
                        <h2 class="position-absolute bottom-0 start-0 end-0 p-2 mb-0 text-center text-white color-1-opacity-8">Care</h2>
                    </a>
                </div>
            </div>
            ...
            <div class="row mb-3">
                <div class="categories__col col-md-4 col-sm-12 mb-3">
                    <a href="#" class="col-md-12 w-100 h-100 d-inline-block p-3 position-relative round-15 overflow-hidden">
                        ...
                        <h2 class="position-absolute bottom-0 start-0 end-0 p-2 mb-0 text-center text-white color-1-opacity-8">Accessories</h2>
                    </a>
                </div>

                <div class="categories__col col-md-8 col-sm-12 mb-3">
                    <a href="#" class="col-md-12 w-100 h-100 d-inline-block p-3 position-relative round-15 overflow-hidden">
                        <div class="bg-sale color-1 position-absolute top-0 bottom-0 end-0 start-0 z-index-1" style="z-index:1"></div>
